...
public class ExampleController {
    ...
    @GetMapping ("ex15")
    public void ex15(@RequestParam("data") String[] datas) {
        //브라우저에서 쿼리스트링으로 보내는거 @RequestParam으로 받는거다. ? data=김의엽&data=김인엽 보내면 log.info에 나온다
        log.info(datas.toString());
    }

    //====================================================================================================
    @GetMapping ("ex16") //%5B [ , %5D ] 쿼리스트링에서 배열은 저렇게 인코딩해서 브라우저에 넣어줘야된다.
    public void ex16(MemberVO member) {
